...
export default defineConfig(async ({ command, isPreview }) => {
  ...
  return {
    ...
    define: { "process.env.NEXT_PUBLIC_FRAME_ZERO_LOCAL_PREVIEW": JSON.stringify("0"), "process.env.FRAME_ZERO_ACCOUNT_NODE_RUNTIME": JSON.stringify("0"), "process.env.NEXT_PUBLIC_FRAME_ZERO_SITE_EDITOR": JSON.stringify("0") },
