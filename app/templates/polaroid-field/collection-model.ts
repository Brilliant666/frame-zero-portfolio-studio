...
export const initialCollections: Collection[] = [
  { id: "preview-positive", name: "正片创作", description: "", coverAssetId: null, coverFit: "natural", coverFocusX: 50, coverFocusY: 50, assetIds: [], focusAssetId: null, visible: true },
  { id: "preview-convention", name: "漫展场照", description: "", coverAssetId: null, coverFit: "natural", coverFocusX: 50, coverFocusY: 50, assetIds: [], focusAssetId: null, visible: true },
  { id: "preview-diary", name: "美少女日记", description: "", coverAssetId: null, coverFit: "natural", coverFocusX: 50, coverFocusY: 50, assetIds: [], focusAssetId: null, visible: true },
];
